...
public abstract class BitGuiContainer extends GuiScreen {
	
	protected static RenderItem itemRender = new RenderItem();
	protected static RenderItem bitItemRender = new BitRenderItem();
    ...
    public BitGuiContainer(Container p_i1072_1_)
    {
    ...
    private void func_146977_a(Slot p_146977_1_)
    {
        ...
        if (!flag1)
        {
            ...
            if(p_146977_1_ instanceof BitSlot)
            	bitItemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack, i, j, s);
            else
    ...
    {
        return slot instanceof BitSlot ? this.func_146978_c(slot.xDisplayPosition + 4, slot.yDisplayPosition + 4, 8, 8, p_146981_2_, p_146981_3_) : this.func_146978_c(slot.xDisplayPosition, slot.yDisplayPosition, 16, 16, p_146981_2_, p_146981_3_);
    }
