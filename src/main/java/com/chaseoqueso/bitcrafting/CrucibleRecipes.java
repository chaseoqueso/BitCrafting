...
public class CrucibleRecipes {
    ...
    private CrucibleRecipes()
    {
        ...
        this.addCrucibleRecipeForBlock(Blocks.SNOW, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "gray", "lightest", .013F, .08F, .03F),
                                                                     ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 16), "lightblue", "lightest", .013F, .08F, .03F, "ice", 0.001F, 0.025F)}, 0.1F);
        ...
        this.addCrucibleRecipeForBlock(Blocks.ICE, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "lightblue", "", .02F, 0.55F, .05F, "ice", 0.001F, 0.025F)}, 0.6F);
        this.addCrucibleRecipeForBlock(Blocks.GLOWSTONE, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "yellow", "dark", .017F, .24F, .06F),
        																  ...
        																  ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 12), "yellow", "", .025F, .08F, .06F, "lightning", 0.001F, 0.025F)}, 0.5F);
        ...
        this.addCrucibleRecipeForBlock(Blocks.REDSTONE_BLOCK, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "red", "", .023F, 0.92F, .06F, "lightning", 0.001F, 0.025F, 2)}, 0.6F);
        ...
        this.addCrucibleRecipeForBlock(Blocks.OBSIDIAN, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "gray", "darkest", .023F, 5.05F, .10F, 4)}, 1.0F);
        ...
        this.addCrucibleRecipeForItem(Items.FLINT, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "gray", "", .017F, .08F, .03F),
																	ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "gray", "light", .017F, .08F, .03F, "earth", 0.001F, 0.025F)}, 0.1F);
        this.addCrucibleRecipeForItem(Items.BRICK, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "red", "dark", .022F, 0.44F, .02F, "earth", 0.001F, 0.025F)}, 0.2F);
        ...
        this.addCrucibleRecipeForItem(Items.FIRE_CHARGE, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "orange", "dark", .022F, 0.55F, .08F),
																		  ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "orange", "", .022F, 0.55F, .08F, "fire", 0.001F, 0.025F)}, 0.7F);
        ...
        this.addCrucibleRecipeForItem(Items.ENDER_PEARL, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "green", "dark", .017F, .24F, .06F),
																		  ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 20), "green", "darkest", .017F, .24F, .06F),
        																  ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 12), "purple", "dark", .02F, 1.08F, .06F, "spatial", 0.001F, 0.025F)}, 0.7F);
        ...
        this.addCrucibleRecipeForItem(Items.BLAZE_ROD, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "orange", "", .017F, 0.55F, .06F),
																	    ...
																	    ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 12), "yellow", "", .023F, 0.44F, .06F, "fire", 0.001F, 0.025F)}, 1.0F);
        this.addCrucibleRecipeForItem(Items.ENDER_EYE, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "lime", "light", .03F, 0.44F, .10F),
																		ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "lime", "", .03F, 0.44F, .06F, "spatial", 0.001F, 0.05F)}, 1.0F);
        ...
        this.addCrucibleRecipeForItem(Items.EMERALD, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "lime", "", .033F, 3.4F, .08F, 2),
																	  ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "lime", "light", .033F, 3.4F, .08F, 2)}, 1.0F);
        ...
        this.addCrucibleRecipeForItem(Items.PRISMARINE_SHARD, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 64), "lightblue", "light", .03F, 0.44F, .03F),
                                                                               ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 32), "cyan", "lightest", .03F, 0.44F, .03F, "ice", 0.001F, 0.025F)}, 1.0F);
        this.addCrucibleRecipeForItem(Items.PRISMARINE_CRYSTALS, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "cyan", "lightest", .035F, 0.88F, .06F, "ice", 0.002F, 0.05F)}, 1.0F);
    ...
    public void addCrucibleRecipe(ItemStack input, ItemStack[] itemstacks, float experience)
    {
        ...
        this.experienceList.put(itemstacks, experience);
    }
    ...
    public float getBreakDownExperience(ItemStack itemstack)
    {
        ...
        while (!this.compareItemStackToArray(itemstack, entry.getKey()));
