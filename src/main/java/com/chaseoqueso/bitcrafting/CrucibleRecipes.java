...
public class CrucibleRecipes {
    ...
    private CrucibleRecipes()
    {
        ...
        this.addCrucibleRecipeForBlock(Blocks.REDSTONE_BLOCK, new ItemStack[] {ItemBit.setBit(new ItemStack(BitCraftingItems.ITEMS.itemBit, 48), "red", "", .023F, 0.92F, .07F, 2)}, 0.6F);
