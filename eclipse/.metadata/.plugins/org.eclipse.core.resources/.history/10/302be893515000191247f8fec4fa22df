...
public class ItemBit extends Item {
	...
	public static final String[] colors = {"gray", "brown", "red", "orange", "yellow", "lime", "green", "cyan", "lightblue", "blue", "purple", "magenta", "pink"};
	...
	{
        if (stack == null || !(stack.hasTagCompound() && stack.getTagCompound().hasKey("color")) || stack.getItem() instanceof ItemClearBit )
		{
			return -1;
		}
		//Goes through every index in the color and shade arrays and picks the right color to tint.
