...
public class ItemBitSword extends ItemSword {
     ...
     */
	public static ItemStack initialize(ItemStack stack, ItemStack[] array, float damage, float durability, float enchantability)
	{
		...
		int i = 0;
		int passes = 256;
		//ResourceLocation location = new ResourceLocation("bcm", "textures/items/" + name + "_" + i + ".png");
		//Minecraft mc = Minecraft.getMinecraft();

		stack.setTagCompound(tagCompound);
		
		/*Makes sure that the ResourceLocation is unique. Only matters if two BitSwords have the same exact name.
		while(mc.getTextureManager().getTexture(location) != null) 
		{
			location = new ResourceLocation("bcm", "textures/items/" + name + "_" + ++i + ".png");
		}*/
